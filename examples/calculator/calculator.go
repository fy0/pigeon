...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					exprs: []any{
						&labeledExpr{
							label: "expr",
							expr:  &ruleIRefExpr{index: 1 /* Expr */},
						},
						&ruleIRefExpr{index: 8 /* EOF */},
					},
				},
			},
		},
		{
			...
			varExists: true,
			expr: &actionExpr{
				run: (*parser).call_onExpr_1,
				expr: &seqExpr{
					exprs: []any{
						&ruleIRefExpr{index: 7 /* _ */},
						&labeledExpr{
							label: "first",
							expr:  &ruleIRefExpr{index: 2 /* Term */},
						},
						&labeledExpr{
							label: "rest",
							expr: &zeroOrMoreExpr{
								expr: &actionExpr{
									run: (*parser).call_onExpr_8,
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 7 /* _ */},
											&labeledExpr{
												label: "op",
												expr:  &ruleIRefExpr{index: 4 /* AddOp */},
											},
											&ruleIRefExpr{index: 7 /* _ */},
											&labeledExpr{
												label: "r",
		...
		},
		{
			...
			varExists: true,
			expr: &actionExpr{
				run: (*parser).call_onTerm_1,
				expr: &seqExpr{
					exprs: []any{
						&labeledExpr{
							label: "first",
							expr:  &ruleIRefExpr{index: 3 /* Factor */},
						},
						&labeledExpr{
							label: "rest",
							expr: &zeroOrMoreExpr{
								expr: &actionExpr{
									run: (*parser).call_onTerm_7,
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 7 /* _ */},
											&labeledExpr{
												label: "op",
												expr:  &ruleIRefExpr{index: 5 /* MulOp */},
											},
											&ruleIRefExpr{index: 7 /* _ */},
											&labeledExpr{
												label: "r",
		...
		},
		{
			...
			expr: &choiceExpr{
				alternatives: []any{
					...
					&actionExpr{
						run: (*parser).call_onFactor_8,
						expr: &labeledExpr{
							label: "integer",
							expr:  &ruleIRefExpr{index: 6 /* Integer */},
						},
					},
				},
			},
...
func (p *parser) call_onExpr_8() any {
	stack := p.vstack[len(p.vstack)-1]
...
func (p *parser) call_onExpr_1() any {
	stack := p.vstack[len(p.vstack)-1]
...
func (p *parser) call_onTerm_7() any {
	stack := p.vstack[len(p.vstack)-1]
	return (func(c *current, op, r any) any {
		return []any{op, r}
		return nil
...
func (p *parser) call_onTerm_1() any {
	stack := p.vstack[len(p.vstack)-1]
	return (func(c *current, first, rest any) any {
		cntCodeBlocks++
		return eval(first, rest)
...
func (p *parser) call_onFactor_2() any {
	stack := p.vstack[len(p.vstack)-1]
	return (func(c *current, expr any) any {
		cntCodeBlocks++
		return expr
...
func (p *parser) call_onFactor_8() any {
	stack := p.vstack[len(p.vstack)-1]
	return (func(c *current, integer any) any {
		cntCodeBlocks++
		return integer
		return nil
	})(&p.cur, stack["integer"])
...
func (p *parser) call_onMulOp_1() any {
	return (func(c *current) any {
		cntCodeBlocks++
		return string(c.text)
		return nil
